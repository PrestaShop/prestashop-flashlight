...
export MYSQL_DATABASE="${MYSQL_DATABASE:-prestashop}"
export MYSQL_EXTRA_DUMP="${MYSQL_EXTRA_DUMP:-}"
export MYSQL_HOST="${MYSQL_HOST:-mysql}"
export MYSQL_PASSWORD="${MYSQL_PASSWORD:-prestashop}"
export MYSQL_PORT="${MYSQL_PORT:-3306}"
export MYSQL_USER="${MYSQL_USER:-prestashop}"
...
export PS_FOLDER="${PS_FOLDER:-/var/www/html}"
